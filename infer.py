...
@click.option('-i', '--in-files', type=click.Path(exists=True), multiple=True, help='Input audio files')
@click.option('-o', '--out-files', type=click.Path(), multiple=True, required=False, help='Output audio files')
