...
class AdaMuonWrapper(ChainedOptimizer):
  ...
  def __init__(self, model, lr, betas, weight_decay=0.0, rank=0, world_size=1):
    adam_groups, adamuon_params = self._configure_optimizers(model, weight_decay)
    ...
    super().__init__(optims, specs, lr=lr, weight_decay=weight_decay)

  @staticmethod
  def _configure_optimizers(model, weight_decay):
